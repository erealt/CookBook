...
import com.estela.cookbook.clases.Usuario;

import java.util.ArrayList;

public class DBHelper extends SQLiteOpenHelper {
    private static final String DATA_BASE="db_cookbook.db";
   ...
   public DBHelper(@Nullable  Context context){
       super(context,DATA_BASE,null,1);
        ...
        db.execSQL("INSERT INTO "+TABLA_CATEGORIA+" ("+CAT_NOMBRE+", "+CAT_FOTO+" ) " +
                ...
                "('Pastas', "+R.drawable.pastas+"), ('Estofados', "+R.drawable.platosfuertes+"), "+
    ...
    public boolean login(String email, String contraseña) throws SQLException {
        ...
        Cursor cursor = datab.rawQuery("SELECT * FROM " + TABLA_USUARIOS +
                " WHERE " + USR_EMAIL + "='"+email+"' AND " + USR_PASS + "='"+contraseña+"' ;", null);
        if (cursor != null) {
    ...
    public ArrayList<Categoria> CargarCategorias(){
        ...
        //QUERY para obtener las categorias
